...
public class ApiOperatorDemo implements Watcher {
  ...
  public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
     ...
     * 
     * //创建节点 String result=zookeeper.create("/node1","123".getBytes(),
     * ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
     * zookeeper.getData("/node1",new ZkClientApiOperatorDemo(),stat); //增加一个
     * System.out.println("创建成功："+result);
     * 
     * //修改数据 zookeeper.setData("/node1","mic123".getBytes(),-1);
     * Thread.sleep(2000); //修改数据
     * zookeeper.setData("/node1","mic234".getBytes(),-1); Thread.sleep(2000);
     * 
     *//*
       * //删除节点 zookeeper.delete("/mic/mic1",-1); Thread.sleep(2000);
       *//*
         * 
         * //创建节点和子节点 String path="/node11";
         * 
         ...
         * ZooDefs.Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT);
         * TimeUnit.SECONDS.sleep(1); } //修改子路径
